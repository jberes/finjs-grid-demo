...
export class GridComponent implements OnInit, AfterViewInit {
    ...
    public chartClick(cell: IgxGridCellComponent) {
        // public chartClick(args, cell) {
        // TODO
        // cell.column.field returns the column
        // console.log(cell.field['Category']);
        // this.selectedTicker1 = cell.field['Category'];
        // Below this line works OK to pass my value to OpenFin, But
        console.log(cell.row.rowData['Category']);
        // i want to get the value into selectedTicker1 of the column 'Category'
        if (fin) {
            fin.desktop.InterApplicationBus.publish('igDemo:changeTicker', {
                item: this.selectedTicker
            });
          }
    }

    public excelClick(cell: IgxColumnComponent) {
        // public chartClick(args, cell) {
        // TODO
        // cell.column.field returns the column
        // console.log(cell.field['Category']);
        ...
        // i want to get the value into selectedTicker1 of the column 'Category'
        if (fin) {
            fin.desktop.InterApplicationBus.publish('igDemo:exportChart', {
                item: this.selectedTicker
            });
          }
    }
